...
| **Instant payments** | Payment intents and Pix-style dynamic charges: create, expire, settle; per-merchant fees netted into a revenue account on settlement; merchants withdraw settled funds through reserved, simulator-executed payouts; settled payments refund fully or partially with fees retained |
...
- [x] M14 — Audit attribution
- [x] M15 — Operator audit log
- [x] M16 — Payouts (money-out)
- [x] M17 — Refunds
